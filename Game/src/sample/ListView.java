...
public class ListView {
    ...
    public ListView(Player player, Canvas canvas) {
        ...
        File file = new File(System.getProperty("user.dir") + "/sprites/cursor2.png");
        cursorImg = new Image(file.toURI().toString());
        file = new File(System.getProperty("user.dir") + "/sprites/arrow.png");
    ...
    public void renderEntryBackground(int ind) {
        File file = new File(System.getProperty("user.dir") + "/sprites/menuBackground4.png");
